...
export const widechar_nonprint = -1;     // The character is not printable.
export const widechar_combining = -2;    // The character is a zero-width combiner.
...
export const widechar_unassigned = -5;   // The character is unassigned.
export const widechar_widened_in_9 = -6; // Width is 1 in Unicode 8, 2 in Unicode 9+.
export const widechar_non_character = -7; // The character is a noncharacter.
